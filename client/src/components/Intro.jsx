...
/**
 * Intro.jsx — polished to match the Landing theme
 *
 * - Preserves all content and structure (no functional changes).
 * - Visual tweaks only: consistent typography, spacing, and hover styles
 *   to match the left sidebar / loading theme from the Landing page.
 * - Button/links get a subtle hover + focus treatment.
 *
 * Keep this file where it already lives: ./components/Intro.jsx
 */

export default function Intro() {
  return (
    <div
      className="min-h-screen flex items-start justify-start bg-[#050f0a] text-gray-100 p-8"
      style={{ fontFamily: "'Inter', 'Poppins', 'Roboto', sans-serif" }}
    >
      <article
        className="prose prose-invert max-w-4xl mx-auto -mt-14 p-10 shadow-[0_12px_40px_rgba(0,0,0,0.7)]"
        style={{
      ...
      >
        ...
        <header className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-extrabold text-green-300 tracking-tight leading-tight">
            Secure, Patient-First Electronic Health Records — Reimagined
          </h1>

          <p className="mt-4 text-gray-300 leading-relaxed max-w-3xl mx-auto text-base md:text-lg">
          ...
          <p className="mt-3 italic text-green-200 text-sm md:text-base">
        ...
        <figure className="my-6">
          <div
            className="w-full h-60 md:h-72 bg-center bg-cover rounded-lg border border-[#123822] flex items-center justify-center overflow-hidden"
            style={{
              backgroundImage:
                "url('https://www.netsuite.com/portal/assets/img/business-articles/erp/social-healthcare-data-security.jpg')",
            }}
          />
          <figcaption className="text-xs text-gray-500 mt-2">
            ...
            "medical records".{" "}
            <a
              className="text-green-200 underline hover:text-green-100 focus:outline-none focus:ring-2 focus:ring-[#0ea45f] focus:ring-opacity-30"
              href="https://unsplash.com/s/photos/healthcare-data-security"
              target="_blank"
              rel="noreferrer"
            >
              Unsplash: healthcare data security
            </a>
            {" • "}
            <a
              className="text-green-200 underline hover:text-green-100 focus:outline-none focus:ring-2 focus:ring-[#0ea45f] focus:ring-opacity-30"
              href="https://unsplash.com/s/photos/blockchain"
              target="_blank"
              rel="noreferrer"
            >
              Unsplash: blockchain
        ...
        <section className="mt-6">
          ...
          <ul className="text-gray-300 list-disc list-inside space-y-2 mt-3">
            <li>
        ...
        <section className="mt-6">
          ...
          <ol className="text-gray-300 list-decimal list-inside space-y-3 mt-3 text-sm md:text-base">
            <li>
        ...
        <section className="mt-6">
          ...
          <figure className="my-4">
            <div
              className="w-full h-48 md:h-64 bg-center bg-cover rounded-lg border border-[#123822] flex items-center justify-center overflow-hidden"
              style={{
                backgroundImage:
                  "url('https://www.esa-automation.com/wp-content/uploads/2024/11/Smart-Contract-Esa-Automation.jpg')",
              }}
            />
            <figcaption className="text-xs text-gray-500 mt-2">
        ...
        <section className="mt-6">
          ...
          <ul className="text-gray-300 list-disc list-inside mt-3 space-y-2 text-sm md:text-base">
        ...
        <section className="mt-6">
          ...
          <div className="mt-6 text-center">
            <a
              href="/auth/signup"
              className="inline-block px-6 py-2 rounded-md bg-gradient-to-r from-[#0ea45f] to-[#0b8f4e] font-semibold text-black transition-transform transform hover:-translate-y-1 hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-[#0ea45f] focus:ring-opacity-30"
              aria-label="Try a quick demo (dummy)"
            >
              Try a quick demo
            </a>
          </div>
